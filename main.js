...
**/
 ...
 import { getData } from './fetch-cat.js';
 import getAnimals from './fetch-animals.js';

document.getElementById('fetch-cat-button').addEventListener('click', () => {
    getData();
  });

document.getElementById('fetch-animals-button').addEventListener('click', () => {
    getAnimals();
  });
